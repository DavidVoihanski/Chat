...
public class server extends JFrame {
	...
	private void initComponents() {
		...
		jTextArea1 = new javax.swing.JTextArea("test");
	...
	private void startServer(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_startServer
		...
		jTextArea1.append("fdsaf");
		server1=new ServerCode(jTextArea1);
		
		new Thread(new StartServer(server1)).start();


		//ServerCode server_1=new ServerCode();
	}
