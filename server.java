...
/**
 * The class containing the gui for the server and the main class to launch it
 * Creates a new ServerCode object when start is pressed
 * @author erlichsefi
 */
public class server extends javax.swing.JFrame {
    ...
    private void startServer(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_startServer
        ...
        server1=new ServerCode(this.jTextArea1);
    ...
    private static ServerCode server1;
